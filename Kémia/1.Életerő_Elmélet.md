...
| $C_{n}H_{2n+2}$  | $C_{6}H_{12}$     | $CH_{3}-CH_{2}-CH_{2}-CH_{2}-CH_{3}$ | [*Rajz*](1.Életerő_Elmélet.excalidraw.md) |
- 
	- Elágazó láncú

| Összeg képlet   | Molekula képlet | Konstitúciós képlet                           | Vonal képlet                                  |
| --------------- | --------------- | --------------------------------------------- | --------------------------------------------- |
| $C_{n}H_{2n+2}$ | $C_{5}H_{12}$   | [*Rajz*](1.Életerő_Elmélet.excalidraw.md) | [*Rajz*](1.Életerő_Elmélet.excalidraw.md) |
- **Gyűrűs** / **ciklikus**

| Összeg képlet | Molekula képlet | Konstitúciós képlet                           | Vonal képlet                                  |
| ------------- | --------------- | --------------------------------------------- | --------------------------------------------- |
| $C_{n}H_{2n}$ | $C_{5}H_{10}$   | [*Rajz*](1.Életerő_Elmélet.excalidraw.md) | [*Rajz*](1.Életerő_Elmélet.excalidraw.md) |
...
- **Aromás**: gyűrűs delokalizált
	- $C_{6}H_{6}$  benzol
	- [*Rajz*](1.Életerő_Elmélet.excalidraw.md)
